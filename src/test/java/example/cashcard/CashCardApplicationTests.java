...
class CashCardApplicationTests {
    ...
    void shouldCreateANewCashCard() {
        ...
        URI locationOfNewCashCard = responseEntity.getHeaders().getLocation();
        ResponseEntity<String> response = restTemplate
                .withBasicAuth("sarah1", "abc123")
                .getForEntity(locationOfNewCashCard.toString(), String.class);
    ...
    @Test
    void shouldNoReturnACashCardWhenUsingBadCredentials() {
        ResponseEntity<String> responseEntity = restTemplate
    ...
    void shouldDeleteAnExistingCashCard() {
        ...
        ResponseEntity<String> getRespone = restTemplate
                .withBasicAuth("sarah1","abc123")
                .getForEntity("/cashcards/99", String.class);

        assertThat(getRespone.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }
